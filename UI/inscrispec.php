                    ...
                    <div class="navbar-nav">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-light m-0">
                                ...
                                <a href="inscrispec.php" class="dropdown-item active">En tant que Spécialiste</a>
                            </div>
                        </div>
  ...
  <main id="main">
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5 mt-4">
            <h2 class="display-2 text-white mb-3 animated slideInDown">Voulez-vous nous joindre?</h2>
        </div>
    </div>
    <!-- Page Header End -->
    ...
    <section class="inner-page pt-4">
      <div class="container">
        <h2 style="border-bottom: 1px solid black;">Inscription: Spécialiste</h2>
        <br>
                  <?php 
                  ...
                  ?>
        <form action="inscrispec-process.php" method="POST" enctype="multipart/form-data">
        <div class="container text-center">
          <div class="row">
            <div class="col">
              <div class="form-floating">
                <input type="text" class="form-control" id="nomSpec" name="nomSpec" placeholder="Nom">
                <label for="nomSpec">Nom</label>
              </div>
            </div>
            <div class="col">
              <div class="form-floating">
                <input type="text" class="form-control" id="prenomSpec" name="prenomSpec" placeholder="Prénom">
                <label for="prenomSpec">Prénom</label>
              </div>
            </div>
            <div class="col">
              <div class="form-floating">
          ...
          <div class="row">
            <div class="col">
              <div class="form-floating">
                <input type="text" class="form-control" id="etabSpec" name="etabSpec" placeholder="Etablissement">
                <label for="etabSpec">Etablissement</label>
              </div>
            </div>
            <div class="col">
              <div class="form-floating">
                <input type="email" class="form-control" id="emailSpec" name="emailSpec" placeholder="Email">
                <label for="emailSpec">Email</label>
              </div>
            </div>
            <div class="col">
              <div class="form-floating">
                <input type="number" class="form-control" id="telSpec" name="telSpec" placeholder="Tél">
                <label for="telSpec">Tél</label>
              </div>
            </div>
          </div>
          <br>
          <div class="row">
            <div class="col">
              <div class="form-floating">
                <input type="text" class="form-control" id="adresseSpec" name="adresseSpec" placeholder="Adresse">
                <label for="adresseSpec">Adresse</label>
              </div>
            </div>
            <div class="col">
            <div class="form-floating">
                          <select name="paysSpec" id="paysSpec" class="form-select">
                            ...
                            <label for="paysSpec">Pays</label>
                        </div>
            </div>
            <div class="col">
              <div class="form-floating">
                <input type="file" class="form-control" id="fichierSpec" name="fichierSpec" placeholder="Documents justificatifs" accept=".pdf">
                <label for="fichierSpec">Documents justificatifs</label>
                <p>Veuillez attacher tous les documents justificatifs à un seul fichier PDF qui ne dépasse pas 2Mo</p>
              </div>
            </div>
          </div>
          <br>
          <div class="row">
            <div class="col">
              <div class="form-floating">
                <input type="password" class="form-control" id="pwSpec" name="pwSpec" placeholder="Mot de passe">
                <label for="pwSpec">Mot de passe</label>
              </div>
            </div>
            <div class="col">
              <div class="form-floating">
                <input type="password" class="form-control" id="reppw" name="reppw" placeholder="Répéter mot de passe">
                <label for="reppw">Répéter mot de passe</label>
              </div>
            </div>
          </div>
          <br>
          <P><font color="red"><u><b>Attention:</b></u> </font>  Vous ne pourrez pas <font color="red"> modifier vos informations </font> une fois que votre compte est créé ( à l'exception des paramètres d'accès).</p>
          <br>
          <div class="row">
            <button class="btn btn-primary btn-lg" style="margin-left: 500px; width: 300px;" type="submit" name="inscrispecbtn">Envoyer</button>
          </div>
        </div>
        </form>
      </div>
