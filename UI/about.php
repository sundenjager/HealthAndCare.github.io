<?php 
  ...
  if(isset($_SESSION["idUser"])){
    ...
    $pwUser = $_SESSION["pwUser"];
    $birthUser = $_SESSION["birthUser"];
    $pays = $_SESSION["pays"];
  ...
  $birthdate = new DateTime($birthUser);
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-lg-0 px-lg-3">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <div class="ms-auto d-none d-lg-flex">
                      ...
                      <a href="profil.php" class="nav-item nav-link active"> <b><?php echo $nomUser." ".$prenomUser; ?></b></a>
                      </div>
                    </div>
                </div>
            </nav>
