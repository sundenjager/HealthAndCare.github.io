    ...
    <section class="inner-page pt-4">
      ...
      <div class="container text-center">
          <div class="row justify-content-center">
              <div class="col-lg-6">
                  <h1 class="mb-4">Votre article a été bien envoyer.</h1>
                  <p class="mb-4">Nous vous remercions d'avoir soumis votre article sur notre site web. Votre article est en cours de traitement, et nous vous demandons de faire preuve de patience pendant cette période. Notre équipe travaille actuellement à son examen et à sa publication.</p>
                  <a class="btn btn-primary py-3 px-5" href="articles.php">Retour à Articles</a>
              </div>
          </div>
      </div>
      </div>
