    ...
    <?php  require("offcanvas.php");?>
     ...
     <div class="container-fluid page-header py-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5 mt-4">
            <h1 style="color: aliceblue;">Créer un article</h1>
            <a href="createarticle.php" class="btn btn-primary btn-lg" style="border-radius: 3px;">Commencer</a>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <div id="carousel<?php echo $resCat["idCat"] ; ?>" class="carousel slide">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item <?php echo $active ? 'active' : ''; ?>">
                    <img src="articleimg/thumbnail/<?php echo $resart['thumbArt']; ?>" class="d-block w-100" alt="...">
