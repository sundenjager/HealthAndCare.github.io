        ...
        <div class="row">
          <div class="col-9" style="margin-left: 35px; border-right: 3px ridge rgb(45, 46, 131); padding-right: 20px; padding-top: 30px;">
              ...
              <div class="row" style="padding-bottom: 20px; padding-top: 30px;">
                  <img src="articleimg/thumbnail/<?php echo $resart["thumbArt"]; ?>" style="border: 3px ridge rgb(45, 46, 131);" alt="">
              </div>
          ...
          <div class="col-1">
              <?php
                  ...
                  <div class="circular">
                      <img src="pfp/<?php echo  $photoSpec;?>" alt="" style="height: 100px; width: auto;">
                  </div>
                      <div class="card-body">
