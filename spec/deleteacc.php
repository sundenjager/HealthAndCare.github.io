        ...
        <div class="row">
            <div class="col-2" style="border-right: 1px solid black;">
                <div class="list-group">
                    ...
                    <a href="deleteacc.php" class="list-group-item list-group-item-action active" aria-current="true">Désactiver Compte</a>
            ...
            <div class="col-8">
                ...
                <button  type="button" class="btn btn-danger btn-lg" data-bs-toggle="modal" data-bs-target="#descmodal" style="margin-left: 550px;">Désactiver</button>
                <div class="modal fade" id="descmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Supprimer Compte</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="deleteaccproc.php" method="POST">
                            <label for="pw">Entrer mot de passe</label>
                            <input type="password" id="pw" class="form-control" name="pw" placeholder="Entrer mot de passe">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</button>
                        <button type="submit"  name="btn" class="btn btn-primary">Confirmer</button>
                        </form>
                    </div>
                    </div>
                </div>
