...
<body>
  ...
  <style>
    ...
    <div class="row">
        ...
        <h1 style="border-bottom: 3px ridge rgb(45, 46, 131);">Articles à la Une</h1>
        ...
        <table class="table table-danger">
          ...
          <tbody>
            <?php 
              $sqlart = "SELECT * FROM article WHERE etatArt = 1 AND alaune = 1";
            ...
            <tr>
              ...
              <td><a class="btn btn-danger" href="deletealaune.php?id=<?php echo $resart['idArt']; ?>">Supprimer</a></td>
