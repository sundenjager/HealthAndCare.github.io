  ...
  <main id="main" style="margin-left: 50px;">
    <section class="inner-page pt-4">
      <div class="row">
        ...
        <h1 style="border-bottom: 3px ridge rgb(45, 46, 131);">Utilisateurs bloqués</h1>
        <br>      
          <table class="table">
            <thead>
              <tr>
              ...
              <tr>
                ...
                <td>
                  <div class="btn-group" role="group" aria-label="Basic example">
                    <a href="unban.php?id=<?php echo $res["idUser"]; ?>" class="btn btn-outline-success">Débloquer</a>
                    <a href="deletebanneduser.php?id=<?php echo $res["idUser"]; ?>" class="btn btn-outline-danger">supprimer définitivement</a>
                  </div>
                </td>
              </tr>
               <!-- Modal -->
