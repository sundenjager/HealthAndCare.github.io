  ...
  <main id="main" style="margin-left: 50px;">
    ...
    <section class="inner-page pt-4">
      <div class="row">
        ...
        <h1 style="border-bottom: 3px ridge rgb(45, 46, 131);">Gestion des Spécialistes</h1>
        <br>
        <div class="row">
          <div class="col">
            <a href="requestspec.php" style="margin-left: 50px;"><u>Liste d'attente</u></a> 
          </div>
          <div class="col">
            <a href="bannedspec.php"><h5 style="margin-left: 350px; color: #c21010;"><u>Spécialistes bloqués</u></h5></a>
          </div>
        </div>
          <table class="table">
            <thead>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="" data-bs-toggle="modal" data-bs-target="#modal<?php echo $res['idSpec']; ?>">Voir</a></td>
                
               <!-- Modal -->
                <div class="modal fade" id="modal<?php echo $res['idSpec']; ?>" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Photo de profil de <?php echo $res['nomSpec']." ".$res['prenomSpec']; ?></h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                      </div>
                      <div class="modal-body">
                        <div class="circular">
                          <img src="../../spec/pfp/<?php echo  $res['photoSpec']; ?>" style="height: 200px; width: auto;">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <td>
                  <a href="" data-bs-toggle="modal" data-bs-target="#biomodal<?php echo $res['idSpec']; ?>">Voir</a>
                </td>
                <!-- Modal -->
                <div class="modal fade" id="biomodal<?php echo $res['idSpec']; ?>" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Bio de profil de <?php echo $res['nomSpec']." ".$res['prenomSpec']; ?></h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                      </div>
                      <div class="modal-body">
                        <div class="circular">
                          <p><?php echo  $res['bioSpec']; ?></p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <td>
                  <a href="blockspec.php?id=<?php echo $res["idSpec"]; ?>" class="btn btn-outline-danger">Block</a>
                </td>
              </tr>
              <?php }}} ?>
            </tbody>
