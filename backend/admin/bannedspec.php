  ...
  <main id="main" style="margin-left: 50px;">
    <section class="inner-page pt-4">
      <div class="row">
        ...
        <h1 style="border-bottom: 3px ridge rgb(45, 46, 131);">Spécialistes bloqués</h1>
        <br>      
          <table class="table">
            <thead>
            <tr>
               ...
               <!-- Modal -->
                ...
                <td>
                  <div class="btn-group" role="group" aria-label="Basic example">
                    <a href="unbanspec.php?id=<?php echo $res["idSpec"]; ?>" class="btn btn-outline-success">Débloquer</a>
                    <a href="deletebannedspec.php?id=<?php echo $res["idSpec"]; ?>" class="btn btn-outline-danger">supprimer définitivement</a>
                  </div>
                </td>
              </tr>
              <?php }} ?>
