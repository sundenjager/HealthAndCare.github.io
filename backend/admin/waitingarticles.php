...
<body>
  ...
  <style>
    ...
    <div class="row">
        ...
        <h1 style="border-bottom: 3px ridge rgb(45, 46, 131);">Articles en attente</h1>
        <br>
        ...
        <table class="table table-success">
          ...
          <tbody>
            <?php 
              $sqlart = "SELECT * FROM article WHERE etatArt = 0";
            ...
            <tr>
              ...
              <td><a class="btn btn-success" href="addarticle.php?id=<?php echo $resart['idArt']; ?>">Ajouter</a></td>
